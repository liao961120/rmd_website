...
```{r}
HTML("<button type='button' class='btn btn-lg btn-danger' data-toggle='popover' title='Popover title' data-content='And here some amazing content. It's very engaging. Right?'>Click to toggle popover</button>")
```
